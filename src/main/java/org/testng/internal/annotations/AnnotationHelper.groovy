...
public class AnnotationHelper {
  ...
  public static IConfigurationAnnotation findConfiguration(IAnnotationFinder finder, Constructor ctor) {
    ...
    if (result == null) {
      ...
      IConfigurationAnnotation asu = (IConfigurationAnnotation) finder.findAnnotation(ctor, IAfterSuite.class);
      ...
      if (bs != null || asu != null || bt != null || at != null || bg != null || ag != null
          || bc != null || ac != null || bm != null || am != null)
      {
        result = createConfiguration(bs, asu, bt, at, bg, ag, bc, ac, bm, am);
      }
    }
  ...
  public static IConfigurationAnnotation findConfiguration(IAnnotationFinder finder, Method m) {
    ...
    if (result == null) {
      ...
      IConfigurationAnnotation asu = (IConfigurationAnnotation) finder.findAnnotation(m, IAfterSuite.class);
  ...
  private static IConfigurationAnnotation createConfiguration(IConfigurationAnnotation bs, IConfigurationAnnotation asu,
...
//    for (Class cls : classes) {
        while (null != cls) {
          ...
          Method[] methods = GroovyClassHelper.getAllMethods(cls);
