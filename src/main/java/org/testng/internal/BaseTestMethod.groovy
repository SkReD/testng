...
public abstract class BaseTestMethod implements ITestNGMethod {
  ...
  public boolean canRunFromClass(IClass testClass) {
    return GroovyClassHelper.isAssignableFrom(testClass.getRealClass(), m_methodClass);
  }
  ...
  public boolean equals(Object obj) {
    ...
    boolean isEqual = m_testClass == null ? other.m_testClass == null
        : other.m_testClass != null &&
          m_testClass.getRealClass().equals(other.m_testClass.getRealClass()) && m_instance == other.getInstance();
